...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=ShoppingCartEntities" DefaultContainerName="ShoppingCartEntities" EnableFlattening="False" EntitySetName="Orders" Include="Product, User,User.MyProfile" EnableUpdate="True">
            ...
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="OrderID" DataSourceID="EntityDataSource1" OnItemCommand="ListView1_ItemCommand">
                ...
                <EmptyDataTemplate>
                    <table id="Table1" runat="server" style="">
                        <tr>
                            <td>You have no selling items in this view.</td>
                        </tr>
                    </table>
                </EmptyDataTemplate>
                <ItemTemplate>
                    ...
                    <asp:TextBox ID="TrackingNumberTextBox" runat="server" Text='<%# Bind("TrackingNumber") %>' />
                        ...
                        <td>
                            <asp:Label ID="ShippingAddress" runat="server" Text='<%# Eval("User.MyProfile.ShippingAddress") %>' />
                        </td>
                        <td>
                            <asp:Label ID="ShippingPostalCode" runat="server" Text='<%# Eval("User.MyProfile.ShippingPostalCode") %>' />
                        </td>
                    </tr>
                </ItemTemplate>
                <LayoutTemplate>
