                ...
                <Fields>
                    <asp:TemplateField HeaderText="First Name" SortExpression="FirstName">
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter Your First Name" ControlToValidate="FirstName" Display="Dynamic" Text="*" CssClass="ErrorMessage"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Last Name" SortExpression="LastName">
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Enter Your Last Name" ControlToValidate="LastName" Display="Dynamic" Text="*" CssClass="ErrorMessage"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Date Of Birth" SortExpression="DateOfBirth">
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter Your Brithday" ControlToValidate="DateOfBirth" Display="Dynamic" Text="*" CssClass="ErrorMessage"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Contact Address" SortExpression="ContactAddress">
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please Enter Your Contact Address" ControlToValidate="ContactAddress" Display="Dynamic" Text="*" CssClass="ErrorMessage"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Contact PostalCode" SortExpression="ContactPostalCode">
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please Enter Your Contact PostalCode" ControlToValidate="ContactPostalCode" Display="Dynamic" Text="*" CssClass="ErrorMessage"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Contact PhoneNumber" SortExpression="ContactPhoneNumber">
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Please Enter Your Contact PhoneNumber" ControlToValidate="ContactPhoneNumber" Display="Dynamic" Text="*" CssClass="ErrorMessage"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Shipping Address" SortExpression="ShippingAddress">
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Please Enter Your Shipping Address" ControlToValidate="ShippingAddress" Display="Dynamic" Text="*" CssClass="ErrorMessage"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Shipping PostalCode" SortExpression="ShippingPostalCode">
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Please Enter Your Shipping PostalCode" ControlToValidate="ShippingPostalCode" Display="Dynamic" Text="*" CssClass="ErrorMessage"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Shipping PhoneNumber" SortExpression="ShippingPhoneNumber">
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Please Enter Your Shipping PhoneNumber" ControlToValidate="ShippingPhoneNumber" Display="Dynamic" Text="*" CssClass="ErrorMessage"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
